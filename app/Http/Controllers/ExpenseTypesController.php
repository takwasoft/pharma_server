...
class ExpenseTypesController extends Controller
{
            ...
            $data = ExpenseType::latest()->get();
                return Datatables::of($data)
                        ...
                        ->addColumn('action', function($row){
                               ...
                               $btn = '<div class="btn-group"><a href="'.URL::to('/').'/expense-types/'.$row->id.'/edit" class="btn btn-sm btn-outline-primary">Edit</a>
    ...
    public function destroy($id)
    {
        ...
        return redirect('expense-types')->with('flash_message', 'ExpenseType deleted!');
    }
}
