<div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="title" type="text" id="title" value="{{ isset($book->title) ? $book->title : ''}}" required>
...
<div class="form-group {{ $errors->has('image') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="image" type="file" id="image" value="{{ isset($book->image) ? $book->image : ''}}" >
...
<div class="form-group {{ $errors->has('user_id') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="user_id" type="number" id="user_id" value="{{ isset($book->user_id) ? $book->user_id : ''}}" >
