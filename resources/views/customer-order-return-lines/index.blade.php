            ...
            <div class="card card-info">
                <div class="card-header">
                    <div class="card-title">
                       Customerorderreturnlines
                    </div>
                    <div class="card-tools">
                        <a class="btn btn-warning" href="{{ url('/customer-order-return-lines/create') }}">Add New</a>
                    </div>
                </div>
                <div class="card-body">
...
<script type="text/javascript">
    ...
    deleteData=(id)=>{
      url=`{{URL::to('/customer-order-return-lines/${id}')}}`;
    ...
    $(function () {
      ...
      var table = $('.data-table').DataTable({
          processing: true,
          serverSide: true,
          ajax: "{{ url('/customer-order-return-lines') }}",
          columns: [
              {data: 'id', name: 'id'},
